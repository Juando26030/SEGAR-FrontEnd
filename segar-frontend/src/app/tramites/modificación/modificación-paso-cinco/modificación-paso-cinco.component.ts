...
@Component({
	standalone: true,
	selector: 'app-modificación-paso-cinco',
	imports: [CommonModule, RouterModule, HttpClientModule],
	templateUrl: './modificación-paso-cinco.component.html',
	styleUrls: ['./modificación-paso-cinco.component.css']
})
export class ModificacionPasoCincoComponent implements OnInit {
	// Sistema de pestañas
