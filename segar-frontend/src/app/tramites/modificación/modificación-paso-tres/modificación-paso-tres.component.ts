...
@Component({
  standalone: true,
  selector: 'app-modificación-paso-tres',
  imports: [
    CommonModule,
    FormsModule,
    RouterModule,
  ...
  templateUrl: './modificación-paso-tres.component.html',
  styleUrls: ['./modificación-paso-tres.component.css']
})
export class ModificacionPasoTresComponent implements OnInit, OnDestroy {
